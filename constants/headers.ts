...
const metaHeaders = {
    books: {
        ...
        meta: (title: string) => [
          { name: 'description', content: `Dive into the intriguing world of ${title}! Explore ratings, author insights, and captivating details that bring this book to life.` },
      ...
      categories: {
        title: 'Explore Books by Categories',
        meta: () => [
