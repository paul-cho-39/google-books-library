/*
  ...
  - You are about to drop the `reading_logs` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "reading_logs" DROP CONSTRAINT "reading_logs_userId_bookId_fkey";
