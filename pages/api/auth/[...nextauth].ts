...
// export const authOptions: NextAuthOptions = (req: NextApiRequest, res: NextApiResponse) => {
...
//          // credentials signin should be assigned to persist session in the database
